...
class product_Test(unittest.TestCase):  # 必须继承unittest.TestCase
    # 前置条件
    def setUp(self) -> None:
    ...
    def test(self):
        ...
        # 选择产品列表
        self.wait.until(expected_conditions.visibility_of_element_located(
            (By.XPATH, '/html/body/div/section/aside/div/ul/li[4]/ul/li[4]/a')))
        self.driver.find_element(By.XPATH, '/html/body/div/section/aside/div/ul/li[4]/ul/li[4]/a').click()
        ...
        # 产品名称
        self.driver.find_element(By.XPATH,
                                 '/html/body/div[2]/div/div[2]/div/div[2]/div[2]/form/div/div[2]/div/span/input').send_keys(
            'UFO')
        ...
        time.sleep(0.5)
        self.driver.find_element(By.XPATH,
                                 '/html/body/div[1]/section/section/main/div/div['
                                 '2]/div/div/div/div/div/div/div/table/tbody/tr[5]/td['
                                 '1]/span/label/span/input').click()
        self.driver.find_element(By.XPATH,
                                 '/html/body/div/section/section/main/div/div[1]/button[2]').click()
        # 编辑产品名称
        time.sleep(0.5)
        self.driver.find_element(By.XPATH, '/html/body/div[2]/div/div[2]/div/div[2]/div[2]/form/div/div['
                                           '2]/div/span/input').clear()
        self.driver.find_element(By.XPATH, '/html/body/div[2]/div/div[2]/div/div[2]/div[2]/form/div/div['
                                           '2]/div/span/input').send_keys('东风')
